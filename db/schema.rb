...
ActiveRecord::Schema.define(version: 2018_10_06_044750) do

  create_table "add_colum_to_test_details", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end

  create_table "add_colum_to_testdetails", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  end
